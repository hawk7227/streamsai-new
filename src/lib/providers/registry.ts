...
// Static adapter instances — no DB dependency
...
/**
 * Resolve the best provider for a given tool type + quality tier.
 * Queries provider_mappings table for the highest-priority active mapping.
 */
export async function resolveProvider(
  toolType: ToolType,
  qualityTier: QualityTier,
): Promise<{ adapter: MediaProvider; mapping: ProviderMapping } | null> {
