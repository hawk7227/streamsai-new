...
export class OpenAIGPTImage1Provider implements MediaProvider {
  ...
  readonly limits: ProviderLimits = { maxConcurrent: 8, requestsPerMinute: 20 };
  ...
  async generate(params: GenerationParams): Promise<GenerationResult> {
    ...
    try {
      ...
      return {
        ...
        durationMs: Date.now() - start, costCents: quality === 'high' ? 17 : 1,
        metadata: { model: 'gpt-image-1', quality, size },
      };
    } catch (err) {
