...
export default function TeamPage() {
  ...
  const loadTeam = async () => {
    ...
    try {
      ...
      setIsClientWorkspace((data?.isClientWorkspace ?? false) as boolean);
    } catch (error) {
  ...
  const handleAcceptInvite = async (inviteId: string) => {
    ...
    try {
      ...
      await loadTeam(); // Reload team to show updated workspace
      await refreshWorkspace(); // Refresh workspace context to reflect new current workspace
    } catch (error) {
      setLoadError(
